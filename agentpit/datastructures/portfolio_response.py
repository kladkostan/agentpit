...
class Position(BaseModel):
    ...
    def model_post_init(self, __context):
        ...
        check_state(len(self.outcome_label) > 0,
                    "Outcome label must not be empty")
        check_state(self.outcome_index >= 0,
                    "Outcome index must be non-negative")
...
class PortfolioResponse(BaseModel):
    ...
    def model_post_init(self, __context):
        ...
        check_state(self.usdc_balance >= 0,
                    "USDC balance must be non-negative")
